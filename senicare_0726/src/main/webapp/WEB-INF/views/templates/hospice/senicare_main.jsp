...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style_jiin.css">
	<link rel="stylesheet" type="text/css" href="css/style.css">
	<link rel="stylesheet" type="text/css" href="css/kge.css">
			...
			<div class="container">
				<div class="banner_content row">
					<div class="col-lg-12" id="col-lg-12-id">						
						<a class="main_btn mr-10 btn_width1" href="../searchHoss_folder/searchHos_1">내 주변<br>의료기관<br>찾기</a>
					</div>
					<div class="col-lg-13" id="col-lg-13-id">						
						<a class="main_btn mr-10 btn_width2" href="../madangs_folder/madang_1_1">참여ㆍ<br>정보마당</a>
					</div>
				...
				<div class="col-lg-4">
					<div class="categories_post">
						...
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="../../../../../resources/static/single-blog.html">
									<h5>Emergency Treatment</h5>
								</a>
								<div class="border_line"></div>
							</div>
