...
<body> <!-- 하단 영역 -->
<div class="menu_list">
	<h3 class="tit"> <strong>시니어<br>구인 · 구직<br>게시판</strong></h3>
	<ul class="menu_list_ul">
		<a class="menu_a" href="../job_folder/job_1.jsp"> 바로구직 </a> 
		<a class="menu_a" href="../job_folder/job_2.jsp"> 일자리 네트워크 </a> 
	</ul>
</div>
