				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<section>
								<head>
									<title>내가 완료한 자가테스트 결과 확인/삭제 페이지</title>	
					
																						
									<link rel="stylesheet" type="text/css" href="kge_mypage1.css">
								  </head>
								  <body>
									<h1 style="font-size: 60px; font-family: 'Nanum Gothin', sans-serif; font-weight: 500; margin-top: -30px; margin-bottom: 70px;">자가테스트 기록</h1>
									<h2 style="color: gray; text-align: center; font-family: 'Nanum Gothic';"> * 테스트 종류를 누르시면 테스트 결과를 확인하실 수 있습니다. *</h2>
									<div class="table-container">
										<table>
										  <thead>
											<tr style="height: 60px; vertical-align: middle; font-size: 30px; margin-top: 100px;">
											  <th style="width:55%;">테스트 종류</th>
