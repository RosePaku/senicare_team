    ...
    <div id="sri_section" >
        <div id="sri_wrap" style="margin-top: 200px;" >
            ...
            <div class="container_input_find">
                <h1 class="title" id = "find_id">기업 회원 아이디 찾기</h1>
                <form id="recoverForm" action="../site/main/member/public/recoverMemberId" method="post">
                  ...
                  <!-- 이름 줄 -->
                  <div class="form-group">
                    <label for="memberName"><strong class="find_title">기업명</strong></label>
                  ...
                  <div class="form-group find_phone">
                      ...
                      <h5 style="font-size:18px; text-align: center; margin-top:8px; margin-left:190px; color:rgb(64, 64, 64);">회원등록시 입력하신 담당자의 휴대전화번호를 입력하세요.</h5>
                    </div>
                  </div>
                  <!-- 휴대전화번호 -->
                  ...
                  <div class="form-group1 find_email">        
                    <div>
                        ...
                        <h5 style="font-size:18px; text-align: center; margin-top:8px; margin-left:110px; color:rgb(64, 64, 64);">회원등록시 입력하신 담당자의 이메일 주소를 입력하세요.</h5>
                    </div>
                  </div>
                  <!-- 이메일주소 -->
                ...
                <h1 class="title" id = "find_id"><br><br>기업 회원 비밀번호 찾기</h1>
                <form id="recoverForm" action="../site/main/member/public/recoverMemberId" method="post">
                  <input type="hidden" name="_sToken" value="1689229764805_63d40fd05050256f1c820c8151931914e1b821533f57714a0c29c762c7a781de">
