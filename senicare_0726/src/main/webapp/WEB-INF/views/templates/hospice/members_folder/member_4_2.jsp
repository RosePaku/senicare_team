				...
				<div class="wrap_terms window_open">
					<div id="contentPrivacy" class="content_privacy">
						<div id="termsPrivacy001" class="article" style="display: block;">
							<h4><p>1. 수집하는 개인정보 항목 및 이용 목적</p></h4>
								...
								<li>
									<div>
										...
										<table cellspacing="0" class="tbl_terms_style __se_tbl " summary="시니케어">
											...
											<tbody>
												<tr class="show">
													...
													<td class="">아이디, 비밀번호, 이름, 휴대폰번호, 생년월일,
														이메일<!--, 본인확인값(CI, DI) 또는 아이핀인증결과--></td>
													<td class="">본인 확인 및 가입의사 확인, 신규 서비스 안내, 설문, 상담 및 문의처리, 회원
														맞춤형 채용정보 제공</td>
												</tr>
										...
										<table cellspacing="0" class="tbl_terms_style __se_tbl" summary="시니케어">
											...
											<tbody>
												<tr class="show">
													<td>쿠키, 서비스이용기록(방문일시, IP, 불량이용기록), 모바일 기기정보(디바이스토큰, 디바이스ID,
														IP주소)</td>
													<td>접속관리, 이용자별 사용환경 제공, 활동정보 파악, 이벤트 및 프로모션 통계 확인</td>
												</tr>
											</tbody>
										</table>

										<p><strong>귀하께서는 회사가 위와 같이 수집하는 개인정보에 대해 동의하지 않거나 개인정보를 기재하지 않음으로써 거부할 수
												있습니다. 다만,
						...
						<div id="termsPrivacy004" class="article bold" style="display: block;">
							<h4><p>2. 개인정보 보유 및 이용기간</p></h4>
							<p>회사는 이용자의 개인정보를 고지 및 동의 받은 사항에 따라 수집∙이용 목적이 달성되기 전 또는 이용자의 탈퇴 요청이 있기 전까지 해당 정보를
								보유합니다. 다만, 아래의 사유로 인하여 보관이 필요한
