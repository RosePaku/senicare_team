									...
									<div role="search" class="dd-privacy-allow">
										<div class="yosegi-InlineWhatWhere">
											<form class="yosegi-InlineWhatWhere-form" id="jobsearch" method="get"
												action="../jobs?q=&amp;l=&amp;from=searchOnHP">
														...
														<div>
															<div class="icl-TextInputClearable">
																<div class="icl-TextInput">
																	...
																	<div class="icl-TextInput-wrapper"><input
																			type="text"
																			aria-labelledby="label-text-input-what"
																			id="text-input-what" name="q"
																			placeholder="직종, 키워드, 회사명 등" value=""
																			autocomplete="off"
												...
												<button class="yosegi-InlineWhatWhere-primaryButton"
													type="submit">
													<font style="vertical-align: inherit;">
														<font style="vertical-align: inherit;">상세 입력하여 검색</font>
													</font>
												</button>
												<button class="yosegi-InlineWhatWhere-primaryButton"
													type="submit">
													<font style="vertical-align: inherit;">
														<font style="vertical-align: inherit;">바로 전체검색</font>
													</font>
												</button> 
												</div>
											</form>
