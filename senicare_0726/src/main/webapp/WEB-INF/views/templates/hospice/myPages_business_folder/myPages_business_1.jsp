					...
					<div class="inner">
						...
						<body>
							<style>
								...
								<form action="/myPages_business_folder/myPages_business_1/update" method="post" style="margin-top: 100px;">
									
									<label for="username">아이디:</label>
									<div style="display: inline-block; vertical-align: top;">
										<input type="text" style="width: 400px;" id="auth_business_id" name="auth_business_id" value="${A_BList[0].auth_business_id}" readonly>
									</div>
									<div
										style="display: inline-block; vertical-align: top; color: red; margin-left: 20px;">
										* 수정불가 *</div>
									<br>
									<br>
									...
									<div style="display: inline-block; vertical-align: top;">
										<input type="text" style="width:250px;" id="name" value="${A_BList[0].auth_business_ceo_name_2}" readonly>
									</div>
									<div
										style="display: inline-block; vertical-align: top; color: red; margin-left: 20px;">
										* 수정불가 *</div>
									...
									<div style="display: inline-block; vertical-align: top;">
										<input type="password" style="width: 400px;" id="auth_business_password" name="auth_business_password" value="${A_BList[0].auth_business_password}"
											placeholder="변경할 비밀번호를 입력하세요">
									</div>
									<br>
									<br>
									<label for="password">전화번호 변경:</label>
									<div style="display: inline-block; vertical-align: top;">
										<input type="text" style="width: 400px;" id="auth_business_phone_number" name="auth_business_phone_number" value="${A_BList[0].auth_business_phone_number}"
											placeholder="변경할 비밀번호를 입력하세요">
									</div>
									<!-- <label for="businessname">기업명:</label>
									<input type="text" style="width:250px;" id="businessname" placeholder="기업명을 입력하세요." value="${A_BList[0].auth_business_id}">
									<br> -->
									<br>
									...
									<div style="display: flex; align-items: center;">
										...
										<input type="text" id="phoneNumber2" style="width: 100px;" maxlength="4"
											placeholder="1234" value="${A_BList[0].auth_business_phone_number.substring(4, 8)}"> 
										<h4>-</h4>
										<input type="text" id="phoneNumber3" style="width: 100px;" maxlength="4"
											placeholder="5678" value="${A_BList[0].auth_business_phone_number.substring(9, 13)}">
									</div> -->
									<br>
									<br>
									<label for="email">이메일:</label>
									<input type="email" style="width:550px;" id="auth_business_email" name="auth_business_email" placeholder="이메일을 입력하세요" value="${A_BList[0].auth_business_email}">
									<br>
									<!-- <br>
									...
									<div style="display: flex; justify-content: center;">
										<button
											style="padding: 10; margin-top: 50px; margin-right: 40px; background-color: #f56a6a; box-shadow: inset 0 0 0 2px #f56a6a; color:white; font-size: 20px; font-family: 'Nanum Gothic', sans-serif;"
											type="button" onclick="refreshPage()">취소</button>
										<button
											style="padding: 10; margin-top: 50px; background-color: #f56a6a; box-shadow: inset 0 0 0 2px #f56a6a; color:white; font-size: 20px; "
											 onclick="app()" type="submit">수정완료</button>
