					...
					<div id="main">
						<div class="inner">
							...
							<section id="banner">
								<div class="content">
									<header>
										<h1 style="font-size: 100px; font-family: 'Nanum Gothin', sans-serif; margin-bottom: -50px;">내가 쓴 글</h1>											
									</header>							
								</div>
							...
							<section>
								<head>
								  ...
								  <body>
									<h1 style="font-size: 60px; font-family: 'Nanum Gothin', sans-serif; font-weight: 500; margin-top: -30px; margin-bottom: 70px;">내가 쓴 글</h1>
									<h2 style="color: gray; text-align: center; font-family: 'Nanum Gothic';"> * 제목을 누르시면 상세 내용을 확인할 수 있습니다 *</h2>
