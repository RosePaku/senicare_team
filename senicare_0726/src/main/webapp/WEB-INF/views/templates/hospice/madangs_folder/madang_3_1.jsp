					...
					<div class="content_box tab_menu_01">
						...
						<div class="col-md-9 contents" style="min-width:768px">
									...
									<fieldset>
										...
										<div class="block search-condition">
											...
											<div class="form-group">
												...
												<label class="locs"><input type="checkbox" name="s_loc" value="전체" class="form-control"  id="s_locs" onclick="checkAll()" <c:if test="${fn:contains(s_loc, '전체')}"> checked </c:if>/>전체&nbsp;&nbsp;&nbsp;</label>
												<label class="locs"><input type="checkbox" name="s_loc" value="전국" class="form-control" <c:if test="${fn:contains(s_loc, '전국')}"> checked </c:if>/>전국&nbsp;&nbsp;&nbsp;&nbsp;</label>
							...
							<c:forEach var="board" items="${list}">
								<!-- 요기부터 -->
								<a href="/madangs_folder/madang_3_2?bno=${board.board_no}&s_opt=${s_opt}&s_word=${s_word}&s_loc=${s_loc}">
								<li class="gridList">
									<!-- 이미지 영역 -->
									<div class="cimg">
										<img src="https://www.bokjiro.go.kr/ssis-tbu/cms/pc/main/banner/1/__icsFiles/afieldfile/2023/05/10/pc_592-360.jpg?nonCachingUsingTime=1690257568861" style="width: 295px; border-radius: 3%">
									</div>
									<div class="ccont">
										<div class="ccont00">
											<!-- 버튼 -->
